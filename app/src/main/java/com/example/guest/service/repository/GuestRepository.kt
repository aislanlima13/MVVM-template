...
import com.example.guest.service.constants.DataBaseConstants
...
class GuestRepository private constructor(context: Context) {
    ...
    fun get(id: Int): GuestModel? {
        ...
        return try {
            ...
            if (cursor != null && cursor.count > 0) {
                ...
                val presence = (cursor.getInt(cursor.getColumnIndex(
                    DataBaseConstants.GUEST.COLUMNS.PRESENCE)) == 1)
    ...
    fun getAll(): List<GuestModel> {
        ...
        return try {
            ...
            val cursor = db.query(DataBaseConstants.GUEST.TABLE_NAME, projection, null,
                null, null, null, null)
